...
export const getAllTopRatedChefOnFrontend = async (slug, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/get-all-chef-by-location-onfronted', {
      method: 'get',
      headers: {
        'Accept': 'application/json',
      },
...
export const subscribe = async (email) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/subscribe/' + email, {
      method: 'get',
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ' + getToken()
