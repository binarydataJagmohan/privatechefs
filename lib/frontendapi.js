...
export const getCurrentUserData = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/getcurrentuserdata",
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const getAllCrusine = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-all-cuisine",
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const SaveBooking = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      `${process.env.NEXT_PUBLIC_API_URL}/save-booking`,
      {
        email: data,
        method: "post",
        headers: {
...
export const socialDataSave = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/social-data-save",
      {
        method: "post",
        headers: {
          Accept: "application/json",
...
export const selectRole = async (id, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/select-role/" + id,
      {
        method: "post",
        headers: {
          Accept: "application/json",
...
export const getEmail = async (email, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-email-data/" + email,
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const UpdateBooking = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      `${process.env.NEXT_PUBLIC_API_URL}/update-booking`,
      {
        email: data,
        method: "post",
        headers: {
...
export const getInstagramImages = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-instagram-images",
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const slugSingleSetting = async (slug, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-slug-setting/" + slug,
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const getAllTopRatedChef = async (slug, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-all-top-rated-chef",
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const getAllLocation = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-all-location",
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const getLocationBySlug = async (slug, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-location-by-slug/" + slug,
      {
        method: "get",
        headers: {
          Accept: "application/json",
...
export const getAllTopRatedChefOnFrontend = async (slug, data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(
      process.env.NEXT_PUBLIC_API_URL + "/get-all-chef-by-location-onfronted",
      {
        method: "get",
        headers: {
          Accept: "application/json",
