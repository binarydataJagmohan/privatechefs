...
export const updateVilla = async (id, data) => {
  return new Promise((resolve, reject) => {
...
export const dishInsert = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL+'/dishInsert', {
      method: 'post',
      headers: {
          'Accept': 'application/json',
      },
...
export const getDishes = async (data) => {
  return new Promise((resolve, reject) => {
    const req = axios.request(process.env.NEXT_PUBLIC_API_URL + '/getDishes', {
      method: 'get',
      headers: {
        'Accept': 'application/json',
        'Authorization': 'Bearer ' + getToken()
