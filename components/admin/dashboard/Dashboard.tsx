                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-6 ">
                    <div className="golden-box m-center h-md-100">
                      ...
                      <h6
                        style={{
                          color: Number(currentbookings) !== 0 || Number(previousbookings) !== 0 ? (Number(currentbookings) >= Number(previousbookings) ? "green" : "red") : "red",
                        }}
                      >
                        {Number(currentbookings) !== 0 || Number(previousbookings) !== 0 ? (Number(currentbookings) >= Number(previousbookings) ? "+" + bookingprecentage + "%" : "-" + bookingprecentage + "%") : "-0%"}
                      </h6>
                    </div>
                  </div>
                  <div className="col-lg-6 col-md-6 col-6 ">
                    <div className="golden-box m-center h-lg-100">
                      ...
                      <h6
                        style={{
                          color: Number(currentusers) !== 0 || Number(previoususers) !== 0 ? (Number(currentusers) >= Number(previoususers) ? "green" : "red") : "red",
                        }}
                      >
                        {Number(currentusers) !== 0 || Number(previoususers) !== 0 ? (Number(currentusers) >= Number(previoususers) ? "+" + usersprecentage + "%" : "-" + usersprecentage + "%") : "-0%"}
                      </h6>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="col-2">
                        <div className="dropdown" id="none-class">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li>
                              <a className="dropdown-item" href="#" onClick={(e) => getSingleBookingUser(e, booking.bookingId)} data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                                View Booking
                              </a>
                            </li>
                          </ul>
