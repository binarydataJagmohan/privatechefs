      ...
      <div className="table-part">
        ...
        <div className="table-box mt-3 ">
          {bookingUsers.length > 0 ? (
                      ...
                      <td>
                        <div className="dropdown" id="none-class">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                              <a className="dropdown-item" target="_blank" href={`/admin/receipts?booking_id=${user.booking_id}`}>
                                View Receipts
                              </a>
                            </li>
                            <li>
            ...
            <>
              <PageFound iconClass={"fa-solid fa-book-open-reader"} heading={" You don't have"} subText={"any active bookings yet"} />
            </>
          )}
        </div>
      </div>
                      ...
                      <tr key={index}>
                        <th scope="row">
                          <div className="form-check">
                            <input className="form-check-input" type="radio" name="id" defaultValue={chef.applied_jobs_id} onChange={handleChange} onBlur={handleBlur} ref={radioRef} defaultChecked={chef.applied_jobs_status == "hired"} />
                          </div>
                        </th>
                        <td>
                        ...
                        <td>
                          <div className="all-form p-0 add-w">
                            <div className="login_div">
                              <input type="number" id={`admin_amount_${chef.applied_jobs_id}`} name={`admin_amount_${chef.applied_jobs_id}`} placeholder="Admin Amount" onChange={handleChange} onBlur={handleBlur} defaultValue={chef.admin_amount} />
                            </div>
                          </div>
                        </td>
                        <td>
                          <div className="all-form p-0 add-w">
                            <div className="login_div">
                              <select name={`user_show_${chef.applied_jobs_id}`} onChange={handleChange} onBlur={handleBlur} defaultValue={chef.user_show} id={`user_show_${chef.applied_jobs_id}`}>
