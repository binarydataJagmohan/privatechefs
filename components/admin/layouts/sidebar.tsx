        ...
        <div className="fixed-left">
          <div className="">
            <div className="text-center">
              <a href="/">
                <img
                  src={process.env.NEXT_PUBLIC_IMAGE_URL + "/images/logo.png"}
                  alt="user-menu"
                  width={70}
                  height={70}
                />
          ...
          <ul className="list-group">
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/bookings"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/assigned-booking"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/invoices" ||
                router.pathname == "/admin/invoices/[id]"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/receipts" ||
                router.pathname == "/admin/receipts/[id]"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/chefs" ||
                router.pathname == "/admin/chefs/[id]"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/concierge" ||
                router.pathname == "/admin/concierge/[id]"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/calender"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/villas" ||
                router.pathname == "/admin/villas2"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/servicechoice"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname == "/admin/top-rated-chef"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            >
            ...
            <a
              ...
              aria-expanded="false"
              className={
                router.pathname === "/admin/cms" || router.pathname === "/admin/frontendlocations"
                  ? "list-group-item list-group-item-action flex-column align-items-start active"
                  : "list-group-item list-group-item-action flex-column align-items-start"
              }
            ...
            >
              <div className="d-flex ">
                ...
                <span className="menu-collapsed">Add Location</span>
              </div>
            </a>
            <a
