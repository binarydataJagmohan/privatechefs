         ...
         <h5 style={{color:"#ff4e00d1"}}>User Detail</h5>
            <div className="user-class pt-5 align-items-center">
                ...
                <div style={{ flex: "2" }}>
                    ...
                    {getUsers.user_city ? (
                        <p><span id="book-user">City</span> : {getUsers.user_city}</p>
                    ) : (
                        null
                    )}
                    {getUsers.user_country ? (
                        <p><span id="book-user">Country </span>: {getUsers.user_country}</p>
                    ) : (
                        null
                    )}
            ...
            <div className="user-class d-flex align-items-center">
                <div className="userImg chef-img-set">
                    ...
                    <p><span id="book-user" style={{wordWrap:"break-word"}}>Preferences</span></p>
                </div>
                <div style={{ flex: "2" }}>
                ...
                {getUsers.cuisine_id && cuisinedata.length > 0 ? (
                    ...
                    {getUsers.additional_notes ? (
                        <p><span id="book-user">Additonal Notes</span> : {getUsers.additional_notes}</p>
                    ) : (
                        null
                    )}
