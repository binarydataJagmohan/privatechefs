...
import { saveService,getServiceDetails,serviceDelete,getSingleService } from '../../../lib/adminapi';
...
export default function ServiceChoice()
{
        ...
        <>
          <div className="table-part">
				...
				<div className="table-box" id='ffff'>
                    ...
                    <li><a className="dropdown-item" href="#" onClick={(e) => editService(e, service.id)}>Edit</a></li>
  ...
  <form className="common_form_error" id="menu_form" >
    ...
    <div className="login_div">
      <label htmlFor="Description">Description:</label>
      <textarea name="description"  onBlur={handleMenuBlur} ></textarea>
    </div>
    <div className="login_div">
      <label htmlFor="Image">Image:</label>
