    ...
    <>
      ...
      <PopupModal show={modalConfirm} handleClose={modalConfirmClose} staticClass="var-login">
        <div className="all-form">
          <form onSubmit={handleSettingUpdate} className="common_form_error" id="menu_form">
            <div className="login_div">
              <label htmlFor="name">Page Name:</label>
              <input name="name" disabled value={SingleSetting.name} />
            </div>
            <div className="login_div">
              <label htmlFor="meta_tag">Meta Tag:</label>
              <textarea name="meta_tag" value={metatag} onChange={(e) => setMetaTag(e.target.value)}></textarea>
            </div>
            <div className="login_div">
              <label htmlFor="meta_desc">Meta Desc:</label>
              <textarea name="meta_desc" value={metadesc} onChange={(e) => setMetaDesc(e.target.value)}></textarea>
            </div>
            <button className="btn-send w-100">Update Page Information</button>
          </form>
        </div>
      </PopupModal>
