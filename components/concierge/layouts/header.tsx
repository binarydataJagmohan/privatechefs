                    ...
                    <div className=' col-10 col-md-6 col-lg-2'>
                        <div className="d-flex align-items-center gx-5 justify-content-end">
                            ...
                            <div className=''>
                                ...
                                <div className="menu">
                                    <ul>
                                        <li><a href={process.env.NEXT_PUBLIC_BASE_URL+'concierge/chats'}><i className="fa-solid fa-comments"></i>&nbsp;Chat</a></li>
                                        ...
                                        <li><a href={process.env.NEXT_PUBLIC_BASE_URL+'concierge/setting'}><i className="fa fa-cog"></i>&nbsp;Settings</a></li>
