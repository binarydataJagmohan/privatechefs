...
import { saveVilla, updateVilla, getSingleVillas, deleteSingleVilla } from "../../../lib/adminapi";
import { getConciergeVillas } from "../../../lib/concierge";
...
export default function Villas() {
  ...
  const getUserData = async () => {
    const data = isPageVisibleToRole("concierge-villas");
    if (data == 2) {
  ...
  const getAllVillasData = async (id: any) => {
    const userData: any = getCurrentUserData();
    getConciergeVillas(userData.id)
      .then((res) => {
        if (res.status == true) {
          setTotalMenu(res.data);
    ...
    <>
                      ...
                      <td>
                        <div className="dropdown" id="none-class">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <li>
                              <a className="dropdown-item" href="#" onClick={(e) => deleteSinglevilla(villa.id)}>
                                Delete
                              </a>
                            </li>
                          </ul>
      ...
      <PopupModal show={modalConfirm} handleClose={modalConfirmClose} staticClass="var-login">
        <div className="all-form" id="form_id">
          <form className="common_form_error" id="menu_form" onSubmit={handleVillaSubmit}>
            <div className="row">
					...
					>
						...
						<div className='mt-4'>
							<button
								...
								disabled={buttonStatus}>{buttonStatus ? 'Please wait..' : 'Update Villas Information'}
							</button>
						</div>
					</form>
				</div>
