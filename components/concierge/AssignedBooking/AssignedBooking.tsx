...
export default function Bookings() {
  ...
  useEffect(() => {
    const data = isPageVisibleToRole("concierge-assigned-bookings");
    if (data == 2) {
  ...
  return (
    <>
      <div className="table-part">
        <h2 className="">Assigned Bookings</h2>
        ...
        <div className="table-box mt-3">
          {bookingUsers.length > 0 ? (
            ...
            <>
              <PageFound iconClass={"fa-solid fa-book-open-reader"} heading={" You don't have"} subText={"any active Hired Jobs yet"} />
            </>
          )}
        </div>
      </div>
