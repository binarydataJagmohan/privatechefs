                    ...
                    <div className="row align-items-center">
                        <div className="col-sm-6">
                            <div className="text-same-formatting top-pad text-right mobile-left tab-m-0 left-areya">
                                ...
                                <p className="mt-3 mb-3 max-80 tab-m-0 f-r ">Meet Alex Samoilis, the culinary visionary behind Private Chefs World. With a Michelin star and the prestigious title of Ambassador of Taste for Global Gastronomy, his culinary journey is nothing short of exceptional.</p>
                                ...
                                <p className="mb-3 max-80 tab-m-0 f-r ">As the owner of Private Chefs World, Alex has delighted the palates of dignitaries and celebrities from all corners of the globe, including the likes of the Prince of Qatar, Princes of Morocco, Bruce Willis, Tom Hanks, Dr. Oz, Grant and Elena Cardone, Will Smith, and Giannis Antetokounmpo, as well as government high-ranked officials from various countries.</p>
                        ...
                        <div className="text-same-formatting mt-5 mobile-left ">
                                <div className="max-80 f-r text-cen">
                                    ...
                                    <p className=" mb-3 tab-m-0 ">At Private Chefs World, we believe in the magic of culinary artistry, where every dish is a love story waiting to be told. Our vision is inspired by the passion and dedication of Alex Samoilis, a culinary visionary with a heart filled with flavors from around the world.</p>
                                    ...
                                    <p className=" mb-3 tab-m-0 ">As we move forward, we continue to embrace the essence of culinary love and adventure. We see Private Chefs World as a platform for lovers of food, where the romance of flavors and the art of dining take center stage. We envision a world where every meal is an ode to love, culture, and shared experiences.</p>
