          ...
          <div className="row">
            ...
            <div className="col-sm-6">
              <div className="banner-text pages-text">
                ...
                <p>
                  Prepare to be introduced to a world of culinary excellence as we proudly present our top-rated Chefs from across the globe. At Private Chefs World, our team of talented culinary artists have not only perfected their craft but also
                  elevated it to new heights. Our culinary artists also understand the importance of hospitality. They take great pride in creating a warm and welcoming atmosphere where guests can relax and enjoy their meal. From the first bite to
                  the last, they are committed to providing an exceptional dining experience, one that is characterized by attention to detail, personalized service, and a genuine love for food. In addition to their work in the kitchen, our culinary
                  artists are active members of the culinary community. They participate in food festivals, cooking competitions, and charity events, sharing their talents and passion with a broader audience. They are also mentors to the next
                  generation of chefs, passing on their knowledge and skills to aspiring culinary artists. In conclusion, our culinary artists are the heart and soul of our dining experience. Their unparalleled talent, creativity, and passion for
                  food are evident in every dish they create. They are not just cooks, but true artists, dedicated to the pursuit of culinary excellence. Whether you are a lifelong foodie or a casual diner, we invite you to experience the magic of
                  their creations and embark on a culinary journey like no other.
                </p>
      ...
      <section className="services-part location-how mt-5 mobile-m-0">
        <div className="container">
          ...
          <p className="dis-max-width mb-4">
            These exceptional Chefs have been curated for their culinary expertise, creativity, and dedication to delighting your taste buds. Each one brings their unique flair to the table, delivering extraordinary dining experiences that resonate
            with the flavors of the world.
          </p>
        </div>
                ...
                <div className="col-lg-2 col-md-6">
                  <div className="slider-img-plase" id="chef-img">
                    ...
                    <p className="plase-btn">
                      <a href={`/privatechef/${data.slug}`}>Chef {data.name && data.name.split(" ")[0]}</a>
                    </p>
                  </div>
                </div>
              ))}
                        ...
                        location.chefs.map((chef) => (
                          <div className="col-lg-2 col-md-6" key={chef.chef_id}>
                            <div className="slider-img-plase" id="chef-img">
                              ...
                              <p className="plase-btn">
                                <a href={`/privatechef/${chef.slug}`}>{chef.name}</a>
                              </p>
                            </div>
                          </div>
                        ))
