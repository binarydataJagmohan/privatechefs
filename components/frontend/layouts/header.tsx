...
export default function Header({ }) {
  ...
  function handleLogout() {
    UpdateUserToOffiline(user_id).then((res) => {
      if (res.status == true) {
        removeToken();
        removeStorageData();
        removeBookingData();
        ...
        <div className="container-fluid">
          <nav className="navbar navbar-expand-lg navbar-light bottom-border ">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ms-auto mt-2 align-items-lg-center ">
                <li className={`nav-item ${router.pathname === "/bookings/step1" ? "active" : ""}`}>
                  <a className="nav-link" href="/bookings/step1">
                    Start your journey
                  </a>
                </li>
                ...
                <li className={`nav-item ${router.pathname === "/ourchefs" ? "active" : ""}`}>
                  <a className="nav-link" href="/ourchefs">
                    Our Chefs
                  </a>
                </li>
                {role == "user" && (
                  <li className={`nav-item ${router.pathname === "/user/messages" ? "active" : ""}`}>
                    <a className="nav-link" href="/user/messages">
                      Message
                    </a>
                  </li>
                )}
                  ...
                  {!current_user_id && (
                    <li className="user nav-item">
                      <div className="dropdown">
                        <div className="banner-btn" style={{ marginTop: "0" }}>
                          {" "}
                          <a
                            className="nav-link set-color-text"
                            href="#"
                            onClick={() => {
                              setRole("chef");
                              signuppopup();
      ...
      <PopupModal show={modalConfirm} handleClose={modalConfirmClose} staticClass="var-login" clientIdExists={clientIdExists}>
        ...
        <div className="all-form">
          ...
          <div className="d-flex justify-content-between sign_up_forgot_password">
            ...
            <p className="text-link text-left my-2">
              <a href="#" onClick={() => forgotpopup()}>
          ...
          <button className="btn-g" onClick={() => signIn("google")}>
            <img src={process.env.NEXT_PUBLIC_BASE_URL + "images/g-logo.png"} alt="g-logo" /> Continue with Google
          </button>

          <button className="btn-g" onClick={() => signIn("facebook")}>
            <img src={process.env.NEXT_PUBLIC_BASE_URL + "images/f-logo.png"} alt="f-logo" /> Continue with Facebook
          </button>
        </div>
      </PopupModal>
      ...
      <PopupModal show={modalConfirmTwo} handleClose={modalConfirmCloseTwo} staticClass="var-login">
        ...
        <div className="all-form">
          <form onSubmit={handleRegisterSubmit} className="common_form_error" id="register_form">
            ...
            <div className="login_div">
              <label htmlFor="password" className="setmobilepass">
                Password:
              </label>
              <div className='position-relative'>
                <input type={showPassword ? "text" : "password"}
                  id="registerpassword" name='password' value={password} onChange={(e) => setPassword(e.target.value)} onBlur={handleRegisterBlur} autoComplete="new-password" />
              ...
              {errors.password && (
                <span className="small error text-danger mb-2 d-inline-block error_login pasword-mobile" style={{ wordWrap: "break-word", marginTop: "-8px" }}>
                  {errors.password}
                </span>
              )}
            </div>
            <div className="login_div">
              ...
              <div className='position-relative'>
                <input type={showconfirmPassword ? "text" : "password"}
                  id="confirmPassword text-danger mb-2 d-inline-block" name='confirmPassword' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} onBlur={handleRegisterBlur} autoComplete="new-password" />
            ...
            <label className="text-start text-decoration-underline fw-bold" role="button" onClick={() => handleAccept()}>
              Acceptance Policy
            </label>
            ...
            {acceptance && (
              <p className="text-start">
                ...
                of Private Chefs World. I understand and consent to the collection, processing, and use of my personal data as outlined in these documents. I acknowledge that my information will be handled in accordance with the applicable data
                protection laws.
              </p>
            )}
            ...
            <div className="login_div mt-2">
              ...
              <label className="form-check-label" htmlFor="flexCheckIndeterminate" style={{ width: "auto", marginLeft: "4px" }}>
                I have read and agree to the{" "}
                <a target="_blank" href="/privacypolicy" className="popup-sign-color">
                  Privacy Policy.
                </a>
              </label>
            ...
            <div className="login_div">
              ...
              <label className="form-check-label mb-4" htmlFor="flexCheckIndeterminate" style={{ width: "auto", marginLeft: "4px" }}>
                I have read and agree to the{" "}
                <a target="_blank" href="/termsconditions" className="popup-sign-color">
                  Terms of Use.
                </a>
              </label>
