              ...
              {data.profile_status === "completed" &&
                ...
                data.created_by === null && (
                  <p className="alert alert-warning">
                    Profile completed, awaiting admin approval to unlock
                    culinary opportunities.
                  </p>
                )}
              {isVisible &&
                data.profile_status === "completed" &&
                data.approved_by_admin === "yes" &&
                data.approval_msg === "yes" &&
                data.created_by === null && (
                  <p className="alert alert-success">
                    Congratulations! Your profile has been completed and
              ...
              <div className="">
                ...
                <div className="menu">
                  <ul>
                    <li className="user_menu">
                      <a href="/chef/myprofile">
                        ...
                        {currentUserData.name
                          ? currentUserData.name.substring(0, 15) + "..."
                          : ""}
                      </a>
                    ...
                    <li>
                      <a
                        href={`${process.env.NEXT_PUBLIC_BASE_URL}privatechef/${data?.slug}`}
                        target="_blank"
                    ...
                    <li>
                      <a href={process.env.NEXT_PUBLIC_BASE_URL + "chef/chats"}>
                    ...
                    <li>
                      <a
                        href={
                          ...
                          `chef/notification/notification?id=${userData}`
                        }
                      >
                    ...
                    <li>
                      <a
                        href={process.env.NEXT_PUBLIC_BASE_URL + "chef/setting"}
                      >
